...
if (isset($_POST['daftar'])) {
    ...
    if ($username == "" || $password == "") {
        ...
        if (mysqli_num_rows($cek) > 0) {
            ...
            $insert = mysqli_query($koneksi, "INSERT INTO admin (username, password) VALUES ('$username', '$enkripPassword')");
            if ($insert) {
                echo '<script>
...
<head>
    ...
    <title>Register Admin - Web Osis</title>
